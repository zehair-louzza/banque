...
🎬 **Tâche 2 — Lancer tous les tests** (palette de commandes → choix de la tâche → tests verts) :
...
🎬 **Tâche 3 — Demarrer l'API livres** (palette de commandes → choix de la tâche → serveur Uvicorn démarré) :

![Démo Run Task dans VS Code : Ctrl+Shift+P, Tasks: Run Task, sélection de « 3. Demarrer l'API livres », message Uvicorn running sur http://127.0.0.1:8000 dans le terminal](docs/vscode_run_api.gif)
